...
# cap.createButton("Back", track, None, cv2.QT_PUSH_BUTTON, 1)
...
while (True):
    ...
    if Do_track:
        cv2.putText(frame, 'Face Tracking Enabled', (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2,
                    cv2.LINE_AA)
    else:
        cv2.putText(frame, 'Face Tracking Disabled', (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2,
                    cv2.LINE_AA)
